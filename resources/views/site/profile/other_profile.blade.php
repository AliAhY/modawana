                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 order-last">
                            <ul
                                ...
                                <li>
                                    @if (
                                        $currentProfile->friends()->where('friend_profile_id', $other_profile->id)->exists() ||
                                            $currentProfile->friendOf()->where('profile_id', $other_profile->id)->exists())
                                        {{-- المنطق عندما يكونان أصدقاء --}}
                                        <p>أصدقاء</p>
                                    @else
                                        {{-- المنطق عندما لا يكونان أصدقاء --}}
                                        <form action="{{ route('friend.request.send', $other_profile->id) }}"
                                            method="POST">
                                            @csrf
                                            <button type="submit">إضافة صديق</button>
                                        </form>
                                    @endif
                        </div>
                        </li>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex align-items-center gap-3 p-3">
                                <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt class="rounded-circle"
                                    width="33" height="33">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex align-items-center gap-3 p-3">
                                <img src="https://bootdey.com/img/Content/avatar/avatar5.png" alt class="rounded-circle"
                                    width="33" height="33">
                                <input type="text" class="form-control py-8" id="exampleInputtext"
                                    aria-describedby="textHelp" placeholder="Comment">
                                <button class="btn btn-primary">Comment</button>
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex align-items-center gap-3 p-3">
                                <img src="https://bootdey.com/img/Content/avatar/avatar2.png" alt class="rounded-circle"
                                    width="33" height="33">
                                <input type="text" class="form-control py-8" id="exampleInputtext"
                                    aria-describedby="textHelp" placeholder="Comment">
                                <button class="btn btn-primary">Comment</button>
