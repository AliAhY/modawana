        ...
        <div class="container mt-5">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-friends" role="tabpanel"
                    ...
                    <h3 class="mb-3 fw-semibold">Friends <span
                            class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">{{ $num_of_frind }}</span></h3>
                    <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 mb-4">
                                <div class="card p-2">
                                    <div class="position-relative">
                                            ...
                                            @if ($request->friendProfile->avatar == null)
                                                @if ($request->friendProfile->gender == 'male')
                                                    <a
                                                        ...
                                                        <img src="{{ asset('images/avatar6.png') }}" alt="Avatar"
                                                            class="w-100 h-100"></a>
                                                @else
                                                    <a
                                                        href="{{ route('profile.other', [$request->friendProfile->name, $request->friendProfile->id]) }}">
                                                        <img src="{{ asset('images/avatar3.png') }}" alt="Avatar"
                                                            class="w-100 h-100"></a>
                                                @endif
                                            @else
                                                @php
                                        ...
                                        <form action="{{ route('friend.request.remove', $request->friendProfile->id) }}"
                                            method="POST">
                                            @csrf
